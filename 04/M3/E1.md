...
Mængden $A$ har $100$ elementer, mængden $B$ har $50$ elementer.

1. Hvis $A \cap B$ har $25$ elementer, hvor mange elementer har $A \cup B$?

    ??? answer "&nbsp;"  
        $|A \cup B| = |A| + |B| - |A \cap B| = 100 + 50 - 25 = 125$

2. Hvis $A \cup B$ har $125$ elementer, hvor mange elementer har $A \cap B$?
...
#### Øvelse 4: Garageporte og indbrudstyve igen
