...
answer-correct: Fordi hvert oktalt ciffer svarer præcist til tre binære cifre (bits).
...
content:
<p><strong>Forklaring:</strong> XOR (exclusive OR) giver 1, hvis de to input-bits er forskellige, og 0, hvis de er ens. Dette svarer præcist til sum-bitten i en addition ($0+1=1$, $1+1=0$). Menten (carry) skal beregnes separat, typisk med en AND-operation.</p>
<?/quiz?>
...
answer: Fordi de kan repræsentere brøker mere præcist end decimalsystemet.
content:
